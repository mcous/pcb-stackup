...
class ColorInput extends React.Component<FieldProps & {id: ColorId}> {
  handleChange: React.ChangeEventHandler<HTMLInputElement> = event => {
    const {id, field, form} = this.props
...
class ColorPresetOption extends React.Component<FieldProps & ColorPreset> {
  handleChange: React.ChangeEventHandler<HTMLInputElement> = () => {
    const {field, form, color} = this.props
  ...
  render(): JSX.Element {
    const {title, color, field} = this.props
